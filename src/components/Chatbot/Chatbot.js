...
const Chatbot = () => {
  ...
  const generateBotResponse = (userInput) => {
    ...
    if (input.includes('lab') || input.includes('test') || input.includes('report')) {
      return 'Lab reports can be created and viewed in the Lab Report section. You can add new lab tests, track results, and share them with patients.';
    }
    ...
    <>
      ...
      <div className={`chatbot-window ${isOpen ? 'open' : ''}`}>
        ...
        <div className="chatbot-body">
          {/* Welcome Message - REMOVED the features list */}
          <div className="welcome-message">
            ...
            <div className="welcome-content">
              ...
              <p>Your AI medical assistant. How can I help you today?</p>
            </div>
          </div>

          {/* REMOVED: Quick Queries section completely */}
